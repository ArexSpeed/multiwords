...
const PuzzlePlay = () => {
  ...
  const checkAnswer = () => {
    ...
    if (correctlyArr.length === wordCorrect.length) {
        ...
        <section className="flex flex-col justify-center items-center w-full min-h-screen">
          ...
          <article>
            {!openHintWord ? (
              ...
              <div className="flex flex-row justify-center items-center">
                ...
                <button
                  className="bg-primaryLight dark:bg-primaryDark p-2 mx-2 rounded-sm"
                  onClick={() => setOpenHintWord(false)}>
                  Hide
                </button>
              </div>
            )}
          ...
          {correct && (
            <article className="flex flex-col justify-center items-center w-full">
              <p>Great you set all letters correct!!</p>
              <p>Now you can back and try next words with more letters</p>
              <Link href="/games/puzzle" passHref>
                <button className="flex flex-row p-2 m-2 bg-primaryLight rounded-md dark:bg-primaryDark">
                  <svg
                    className="w-6 h-6"
